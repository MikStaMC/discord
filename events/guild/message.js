    ...
    const validPermissions = [
      ...
      if(command.hasOwnProperty('permissions')){
        ...
        if (invalidPerms.length){
            ...
            .setAuthor("Missing information", "https://media.discordapp.net/attachments/827688182471852076/828026850902802432/yj1UwM7.png")
            .setDescription(`**You do not have access to this command. Contact Mik+#4517 if there is a problem.**`)
